...
from ultralytics.nn.modules import (
    ...
    C2fCIB,
    C2fPSA,
    # 中文注释：导入 AKCMamba 复现模块，保证 YAML 中的模块名可以被 parse_model 解析。
    C3AKC,
    C3AKCMamba,
    C3SASSAKCMamba,
    C3Ghost,
    ...
    base_modules = frozenset(
        {
            ...
            C2,
            C2f,
            # 中文注释：AKCMamba 层遵循 [c1, c2, ...] 约定，需要参与宽度缩放。
            C3AKC,
            C3AKCMamba,
            C3SASSAKCMamba,
            C3k2,
            ...
            SCDown,
            C2fCIB,
            # 中文注释：4CAKCMamba 用于 Neck，同样需要参与通道宽度缩放。
            C4AKC,
            C4AKCMamba,
            C4SASSAKCMamba,
            A2C2f,
    ...
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            ...
            C2,
            C2f,
            # 中文注释：AKCMamba 层内部接收 repeat 数，需与 C2f 一样由 parse_model 注入 n。
            C3AKC,
            C3AKCMamba,
            C3SASSAKCMamba,
            C3k2,
            ...
            C2fPSA,
            C2fCIB,
            # 中文注释：4CAKCMamba 内部也接收 repeat 数，需由 parse_model 注入 n。
            C4AKC,
            C4AKCMamba,
            C4SASSAKCMamba,
            C2PSA,
